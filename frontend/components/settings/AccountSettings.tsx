...
export default function AccountSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        >
          ...
          <div className="md:col-span-2 flex justify-end">
            {/* Hidden submit or visible if needed, Image 1 doesn't show button for Email specifically, maybe 'Save Changes' at bottom affects all? Image 1 shows a bottom bar "Hủy bỏ / Lưu Thay Đổi" */}
          </div>
        </form>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-red-500 text-xl border">
                <FaGoogle />
              </div>
              <div>
            ...
            <button className="px-4 py-1.5 border border-gray-300 rounded-lg text-xs font-bold text-gray-600 hover:bg-white hover:shadow-sm transition">
              Ngắt kết nối
            </button>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-blue-600 shadow-sm flex items-center justify-center text-white text-xl border-blue-600">
                <FaFacebook />
              </div>
              <div>
            ...
            <button className="px-4 py-1.5 bg-blue-500 text-white rounded-lg text-xs font-bold hover:bg-blue-600 transition shadow-lg shadow-blue-200">
              Kết nối ngay
            </button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <select className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-medium outline-none focus:border-blue-500 bg-white text-gray-900">
      ...
      {/* Global Actions */}
      <div className="flex justify-end gap-3 pt-6 pb-20 md:pb-0">
        <button className="px-6 py-2.5 rounded-full font-bold text-gray-500 hover:bg-gray-100 transition">
          Hủy bỏ
        </button>
        <button
          onClick={handleUpdatePassword}
          className="px-8 py-2.5 bg-blue-500 text-white rounded-full font-bold shadow-lg shadow-blue-200 hover:shadow-blue-300 transition hover:-translate-y-0.5"
        >
          Lưu Thay Đổi
        </button>
      </div>
